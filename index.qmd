---
title: "Viewing Multiple Interactive Plots With [`plotly`](https://plotly.com/r/) And [`trelliscopejs`](https://hafen.github.io/trelliscopejs/)"
author: "Jeremy Selva"
format:
  revealjs:
    controls: true
...
Quality control samples helps to check the severity of variation from external sources such as contaminant ions. We want to keep molecules that gives a low variation on the quality control samples. Plots are exported as pages in a pdf file.
...
Today's targeted lipidomics workflow can measure up to a few hundred molecules. This gives a pdf file of over 500 pages. Looking at these static plot individually to gain insights is tedious.
